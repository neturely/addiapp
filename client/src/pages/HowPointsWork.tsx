...
/** One guide section: icon chip + heading + friendly prose. */
function Section({
  icon,
  iconClass,
  title,
...
export function HowPointsWork() {
  ...
  if (!points) {
    return (
      <main className="flex min-h-40 items-center justify-center p-8 text-muted">
  ...
  return (
    <main className="mx-auto w-full max-w-2xl p-4 pb-10 sm:p-6">
      <h1 className="mb-1 text-2xl font-bold tracking-tight text-gray-800">How points work</h1>
        ...
        >
          ...
          <ul className="list-disc space-y-1 pl-5">
            <li>
              ...
              {limits.minScoringMinutes === 1 ? 'a minute' : `${limits.minScoringMinutes} minutes`}{' '}
